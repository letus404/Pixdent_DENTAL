                        ...
                        <div class="form-bottom">
                            <form role="form" action="<?php echo base_url();?>auth/login" method="post" class="login-form">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="form-username" name="username" placeholder="Usuario..." class="form-username form-control" aria-label="Nombre de Usuario">
                                </div>
                                <div class="form-group">
                                    <label class="sr-only" for="form-password">Contraseña</label>
                                    <input type="password" id="form-password" name="password" placeholder="Contraseña..." class="form-password form-control" aria-label="Contraseña">
                                </div>
